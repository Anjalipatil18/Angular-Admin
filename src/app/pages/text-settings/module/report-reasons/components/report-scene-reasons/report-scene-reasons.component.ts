...
@Component({
  selector: 'app-report-scene-reasons',
  templateUrl: './report-scene-reasons.component.html',
  styleUrls: ['./report-scene-reasons.component.scss'],
})
export class ReportSceneReasonsComponent implements OnInit {
  reasons: any;
  reasonsSearch = [];
  reasonsData = [];
  columns: any;
  ...
  // get enabled reasons
  getAllReport() {
    this.service.reportReasons(3).subscribe(
      (res: any) => {
        console.log('reportReasons/3', res);
