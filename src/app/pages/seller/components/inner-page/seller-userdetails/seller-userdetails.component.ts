...
@Component({
  selector: 'app-seller-userdetails',
  templateUrl: './seller-userdetails.component.html',
  styleUrls: ['./seller-userdetails.component.scss'],
})
export class SellerUserdetailsComponent implements OnInit {
  constructor(
