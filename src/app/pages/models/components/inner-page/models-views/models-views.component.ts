...
@Component({
  selector: 'app-models-views',
  templateUrl: './models-views.component.html',
  styleUrls: ['./models-views.component.scss'],
})
export class ModelsViewsComponent implements OnInit {
