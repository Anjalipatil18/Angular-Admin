...
@Component({
  selector: 'app-models-userdetails',
  templateUrl: './models-userdetails.component.html',
  styleUrls: ['./models-userdetails.component.scss'],
})
export class ModelsUserdetailsComponent implements OnInit {
  constructor(
