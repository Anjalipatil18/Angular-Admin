...
@Component({
  selector: 'app-models-parameters',
  templateUrl: './models-parameters.component.html',
  styleUrls: ['./models-parameters.component.scss'],
})
export class ModelsParametersComponent implements OnInit {
  constructor(
