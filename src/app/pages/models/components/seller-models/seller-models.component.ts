...
@Component({
  selector: 'app-seller-models',
  templateUrl: './seller-models.component.html',
  styleUrls: ['./seller-models.component.scss'],
})
export class SellerModelsComponent implements OnInit {
  constructor(
