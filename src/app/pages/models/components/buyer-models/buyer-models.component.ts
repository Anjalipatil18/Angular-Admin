...
@Component({
  selector: 'app-buyer-models',
  templateUrl: './buyer-models.component.html',
  styleUrls: ['./buyer-models.component.scss'],
})
export class BuyerModelsComponent implements OnInit {
  constructor(
