...
@Component({
  selector: 'app-rating-userdetails',
  templateUrl: './rating-userdetails.component.html',
  styleUrls: ['./rating-userdetails.component.scss'],
})
export class RatingUserdetailsComponent implements OnInit {
  constructor(
