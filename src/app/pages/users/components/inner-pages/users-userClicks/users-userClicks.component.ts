...
@Component({
  selector: 'app-users-user-clicks',
  templateUrl: './users-userClicks.component.html',
  styleUrls: ['./users-userClicks.component.scss'],
})
export class UsersUserClicksComponent implements OnInit {
  userActiveData: any = [];
  ...
  constructor(
    ...
    private breadCrumbice: Ng7DynamicBreadcrumbService
  ) {}
  ...
  ngOnInit() {
    ...
    this.breadCrumbice.updateBreadcrumbLabels(breadcrumb);
  }
