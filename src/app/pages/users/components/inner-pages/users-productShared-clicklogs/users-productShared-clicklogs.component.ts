...
@Component({
  selector: 'app-users-productshared-clicklogs',
  templateUrl: './users-productShared-clicklogs.component.html',
  styleUrls: ['./users-productShared-clicklogs.component.scss'],
})
export class UsersProductSharedClickLogsComponent implements OnInit {
  userActiveData: any = [];
  ...
  ngOnInit() {
    this.route.params.subscribe(params => {
      console.log(
        'params---------inner inner-------ngOnInit-------------users',
        params
      );
