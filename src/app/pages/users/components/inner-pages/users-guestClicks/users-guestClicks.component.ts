...
@Component({
  selector: 'app-users-guest-clicks',
  templateUrl: './users-guestClicks.component.html',
  styleUrls: ['./users-guestClicks.component.scss'],
})
export class UsersGuestClicksComponent implements OnInit {
  userActiveData: any = [];
