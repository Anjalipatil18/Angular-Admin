...
@Component({
  selector: 'app-reported-colors',
  templateUrl: './reported-colors.component.html',
  styleUrls: ['./reported-colors.component.scss'],
})
export class ReportedColorsComponent implements OnInit {
  constructor(
