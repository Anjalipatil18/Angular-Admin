...
@Component({
  selector: 'app-colors-comments',
  templateUrl: './colors-comments.component.html',
  styleUrls: ['./colors-comments.component.scss'],
})
export class ColorsCommentsComponent implements OnInit {
  ...
  getAllColors() {
    ...
    this.service.colorsCommentsList(list).subscribe(
      (res: any) => {
