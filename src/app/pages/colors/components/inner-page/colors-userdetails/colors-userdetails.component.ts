...
@Component({
  selector: 'app-colors-userdetails',
  templateUrl: './colors-userdetails.component.html',
  styleUrls: ['./colors-userdetails.component.scss'],
})
export class ColorsUserdetailsComponent implements OnInit {
  constructor(
