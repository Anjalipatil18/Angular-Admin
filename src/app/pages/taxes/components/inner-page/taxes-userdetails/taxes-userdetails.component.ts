...
@Component({
  selector: 'app-taxes-userdetails',
  templateUrl: './taxes-userdetails.component.html',
  styleUrls: ['./taxes-userdetails.component.scss'],
})
export class TaxesUserdetailsComponent implements OnInit {
  constructor(
