...
@Component({
  selector: 'app-promotors-likes',
  templateUrl: './promotors-likes.component.html',
  styleUrls: ['./promotors-likes.component.scss'],
})
export class PromotorsLikesComponent implements OnInit {
  constructor(
  ...
  getAllPromotors() {
    ...
    this.service.promotorsLikesList(list).subscribe(
      (res: any) => {
