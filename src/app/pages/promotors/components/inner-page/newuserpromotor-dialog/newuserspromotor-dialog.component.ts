...
@Component({
  selector: 'app-newuserspromotor-dialog',
  templateUrl: './newuserspromotor-dialog.component.html',
  styleUrls: ['./newuserspromotor-dialog.component.scss'],
})
export class NewUsersPromotorsDialogComponent implements OnInit {
  constructor(
    protected ref: NbDialogRef<NewUsersPromotorsDialogComponent>,
  ...
  getUsers(data: any) {
    ...
    const list = {
      ...
      // not mandatory
      profilePic:
        typeof this.imagesUrl === 'undefined' ? '' : this.imagesUrl.imageLink,
      // termsAndCond: '',
    ...
    console.log('new user form submit data', list);
    ...
    if (this.addForm.invalid) {
      ...
      this.service.postPromotor(list).subscribe(
        (res: any) => {
    ...
    //   this.service.postPromotor(data).subscribe(
    //     (res: any) => {
    //       console.log('addAdminUsers/', res);
    //       this.ref.close(1);
    //     },
