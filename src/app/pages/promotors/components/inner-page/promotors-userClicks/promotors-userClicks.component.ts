...
@Component({
  selector: 'app-promotors-userclicks', //
  templateUrl: './promotors-userClicks.component.html',
  styleUrls: ['./promotors-userClicks.component.scss'],
})
export class PromotorsUserClicksComponent implements OnInit {
  userActiveData: any = [];
